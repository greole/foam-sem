...
# Batteries included, numereous modules on pypi
# Many Python API's e.g. Paraview
##

# Active community
# https://www.youtube.com/watch?v=OSGv2VnC0go # Hettinger - Beatiful Code
...
example_list = [1,2,3,"a","b","c"] #extremly important

example_persons = ["Alice", 1.60, "Bob", 1.80] # but dont do this
